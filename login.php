...
<head>
  ...
  <! -- Title -->
  <title>Aplikasi Gudang SSC ICT dengan PHP 8 dan MySQLi</title>
...
<body class="login">
  ...
  <div class="wrapper wrapper-login">
    <div class="container container-login animated fadeIn">
      ...
      <!-- judul -->
      <h3 class="text-center">Aplikasi Catatan Gudang <br>SSC ICT</h3>
      <!-- form login -->
      <form action="proses_login.php" method="post" class="needs-validation" novalidate>
        ...
        <div class="login-footer mt-4">
          <span class="msg">&copy; Magang USTJ - 2024</span>
         </div>
      </form>
    </div>
  </div>
